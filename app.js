...
module.exports = {
  ...
  getUserInfos: function(user) {
    return this.get("./db/github-pierregaudichon.json");
  },
  getReposList: function(user) {
    return this.get("./db/github-pierregaudichon-repos.json");
  }
};



},{"reqwest":68}],66:[function(require,module,exports){
require("insert-css")(".top-bar{height:10px}");
var __vue_template__ = "<div class=\"contener\">\n\t<div class=\"top-bar row indigo darken-4\"></div>\n\t<div v-component=\"user\"></div>\n</div>";
module.exports = {
  components: {
...
},{"./user.vue":67,"insert-css":2}],67:[function(require,module,exports){
require("insert-css")(".rotate-90{transform:rotate(90deg)}.bottom-44{margin-bottom:44px}.image-row{height:196px}");
var __vue_template__ = "<div class=\"row image-row\">\n\t\t<div class=\"col offset-s5 s2\">\n\t\t\t<img v-if=\"found\" class=\"responsive-img circle\" v-attr=\"src : user.avatar_url\" alt=\"Avatar\">\n\t\t</div>\n\t</div>\n\n\n\t<div class=\"row\">\n\t\t<div class=\"col offset-s3 s6 input-field\">\n\t\t\t<input id=\"username\" type=\"text\" v-model=\"userField\" lazy=\"\">\n\t\t\t<label for=\"username\" class=\"active indigo-text text-darken-3\">Username</label>\n\t\t</div>\n\t</div>\n\n\t<div class=\"row\">\n\t\t<div class=\"col offset-s3 s6 right-align\">\n\t\t\t<a href=\"{{user.html_url}}\">\n\t\t\t\t@{{user.login}}\n\t\t\t</a>\n\t\t</div>\n\t</div>\n\n\t<div class=\"row\">\n\t\t<div v-if=\"!found &amp;&amp; initialized\" class=\"col offset-s3 s6 card-panel red white-text flow-text\">\n\t\t\tNot Found\n\t\t</div>\n\t</div>\n\n\n\t<div class=\"row\">\n\t\t<div class=\"col offset-s3 s6\">\n\t\t\t<div class=\"collection\">\n\t\t\t\t<a v-repeat=\"repo : repos\" class=\"collection-item indigo-text text-darken-3\" href=\"{{repo.html_url}}\">\n\t\t\t\t\t{{repo.name}}\n\t\t\t\t</a>\n\t\t\t</div>\n\t\t</div>\n\t</div>";
var store;
...
module.exports = {
  ...
  methods: {
    getInfos: function() {
      return store.getUserInfos(this.userField).fail((function(_this) {
        return function() {
        ...
        return function(infos) {
          _this.found = true;
          _this.user = infos;
          return _this.getRepos();
        };
      })(this));
    },
    getRepos: function() {
      return store.getReposList(this.userField).then((function(_this) {
        return function(list) {
          return _this.repos = list.sort(function(a, b) {
...
},{"./../store":65,"insert-css":2}],68:[function(require,module,exports){
/*!
...
},{"./vues/app.vue":66,"director":1,"vue":63}]},{},[69]);
